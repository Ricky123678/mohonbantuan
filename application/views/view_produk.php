              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="barcode" name="barcode" autocomplete="off" class="form-contorl input-sm"
                      placeholder="Barcode">
                  </div>
                </div>
              </div>
...
<script type="text/javascript">
  $(document).ready(function (){
    ...
    $(document).on("click", "#btnTambah", function(e){
      ...
      $('#formModal').modal('show'); // Tampilkan boostrap modal
    ...
    $("#tbl_data").on('click', '.btn_hapus',function(e){
      ...
      Swal.fire({
        title: 'Hapus Data?',
        text: 'Anda Yakin menghapus Data Produk ini?',
        icon: 'warning',
