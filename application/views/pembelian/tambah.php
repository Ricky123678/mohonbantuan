...
<div class="container-fluid">
    <form action="" method="post" id="form_beli">
        <div class="row">
            <div class="col-md-6">
                <labael for="">Data Customer</label>
        ...
        <div class="row">
            ...
            <div class="col-md-1">
                <div class="form-group">
                    ...
                    <input readonly type="text" id="stock" name="stock" class="form-control input-sm">                       
                </div>
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-1">
                <label for="">Jumlah <soan class="text-danger">*</span></label>
                <div class="form-group">
            ...
            <input id="total" size="16" style="text-align:right;color:blue;font-weight: bold;"
                    name="total" class="C" type="hidden" readonly>
        </div>
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-xs-3">
                            <div class="form-group">
                                 <label>J. Tempo</label>
                                 <input readonly name="dt_tempo" id="dt_tempo" type="text" calss="form-control input-sm" required>                       
                                </div>
                            </div>
                        ...
                        <div class="col-xs-11">
                            <div class="box-tools pull-right">
                                ...
                                <button type="button" disabled="disabled" id="btn_batal" calss="btn btn-sm btn-danger btn_batal">
                                            ...
                                            <tbody>
                                                <tr class="success" style="background-color: #f9f9f9 !important; font-weight: bold; font-size: 16px;">
                                                    ...
                                                    <td style="text-align: right !important;">
                                                        ...
                                                        style="width:120px;text-align: right;font-weight: bold; font-size: 16pxx;color:red" />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="active" style="background-color: #f9f9f9 !important; font-size: 14px;">
                                                    ...
                                                    <td style="text-align: right !important:">
                                                        <imput id="nilai_potong" name="nilai_potongan" readonly
                                                ...
                                                <tr class="info" style="background-color: #f9f9f9 !important; font-size: 14px;">
                                                    <td colspan="1">PPN</td>
                                                    <td style="text-align: right !important:">
                                                        <imput id="ppn" name="ppn" readonly
                                                        style="width:120px;text-align: right;" type="text" autocomplete="off"/>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="active" style="background-color: #f9f9f9 !important; font-size: 14px;">
                                                    ...
                                                    style="width:120px;text-align: right;" type="text" onkeyup="hitungan_total()" autocompete="off"/>
                                                </td>
                                            </tr>

                                            <tr class="active" style="background-color: #f9f9f9 !important; font-weight: bold; font-size: 16px;">
                                                <td colspan="1">#GRAND TOTAL</td>
                                                <td style="text-align: right !important;">
                                                    <input id="grandtotal" name="grandtotal" type="text" readonly
                                                    style="width:120px;text-align: right;fint-weight: bold; font-size: 16px;color:red" ?>
                                                </td>
                                            </tr>
    ...
    <div class="modal-dialog modal-lg" role="dokumen">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-borderd table-condensed" id="tblBarang">
                    <thead>
                        <tr>
                            <th style='width:200px;'>Nama Barang</th>
                            <th style='width:10px;text-align: right;'>Harga Beli</th>
                            <th style='width:10px;text-align: right;'>Harga Jaal</th>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
                    ...
                    success: function(response){
                        ...
                        var html = "";
                            for(i=0;i < response.length ; i++){
                                ...
                                +'<td><center>'+'<span><button barang-id="' + response[i].id_produk+
                                    '"class="btn btn-success btn-xs btn_pilih">Pilih Data</button></span>' + '</td>'
                                + '</tr>'
                            };
            ...
            $("#dataBarang").on('click','.btn_pilih',function(e){
                e.preventDefault();
                var id_produk = $(this).attr('barang-id');
                if (id_produk ==""){
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            if (data.responce == "Success") {
                                ...
                                let harga_beli=parseFloat(data.post.harga_beli).toFixed(0).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
                                let harga_pokok=parseFloat(data.post.harga).toFixed(0).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
                                let stok=parseInt(data.post.stok);
                                if (isNaN(stok)) stok = 0;
                                $('#nama_barang').val(data.post.nama_produk);
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>pembelian/getListBarang',
                type: 'POST',
                dataType: 'json',
                delay: 800,
                ...
                var diskon=parseInt(0);
                var nilai_diskon=parseInt(0);
                for(i=0;i < response.length ; i++){
                    no++;
                    ...
                    var total_beli=parseFloat(total).toFixed(0).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
                    var potongan=parseFloat(nilai_diskon).toFixed(0).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
            ...
            $(document).on("click", "#btn_batal", function(e){
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return new Promise(function(resolve,reject) {
                            $.ajax({
                                url:'<?php echo_url(); ?>pembelian/hapusTransaksi',
                                type: 'POST',
                                dataType: "json"
                                data: {no_faktur: no_faktur}
                            })
            ...
            //Simpan Data Transaksi Pembelian Final
            $(document).on("click", "#btn_simpan", function(e){
                ...
                if (is_bayar==0 && term==""){
                    swal.fire({
                        icon: 'error',
                        title: 'Terjadi Kesalahan! <br> Jangka Waktu Pembayaran belum di Isi',
                        text: 'Jangka Waktu Pembayaran Wajib di Isi'});
                } else {
                    $.ajax({
                        ...
                        delay: 250,
                        data:{
                            no_faktur: no_faktur, id_supp:id_supp, tgl_beli:tgl_beli, total_beli:total_beli, is_bayar:is_bayar,
                            potongan:potongan, ppn:ppn, biaya:biaya, total_bersih:total_bersih, term:term,tgl_tempo:tgl_tempo
                        },
                        beforesend: function () {
                            $this.button('loading');
                        },
