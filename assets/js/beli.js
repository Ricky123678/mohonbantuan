...
//hitung nilai margin
    ...
    function hitung_total() {
        ...
        let grandtotal=parseInt(jum_bersih,10)+parseInt(nilai_pajak,10)+parseInt(biaya,10);
    ...
    function addDays(date, days) {
        ...
        result.setDate(result.getData() + days);
        return result;
    }

    //membuat format tanggal dd/mm/yy
    function setFprmatDate(date){
        var dd = date.getDate();
    ...
    //fungi untuk memasukkan tanggal jatuh tempo    
